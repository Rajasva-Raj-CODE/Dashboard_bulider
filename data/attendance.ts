...
export const attendanceStats = [
  {
    ...
    tooltip: "Number of working days in selected range",
  },
  {
    ...
    tooltip: "Headcount considered for attendance",
  },
  {
    title: "Total Leaves",
    value: "0",
    ...
    iconColor: "text-brand-primary-700",
    tooltip: "All leave days recorded",
  },
  {
    title: "Total Unplanned Leaves",
    value: "0",
    icon: CalendarX2,
    bgColor: "bg-brand-secondary-100",
    iconColor: "text-brand-secondary-700",
    tooltip: "Unplanned/Unapproved leave days",
  },
  {
    title: "Total Planned Leaves",
    value: "0",
    icon: CalendarCheck2,
    bgColor: "bg-brand-primary-50",
    iconColor: "text-brand-primary-600",
    tooltip: "Approved planned leave days",
  },
];
...
export const dayWiseAbsenceData = {
  labels: Array.from(
    { length: 60 },
    (_, i) => `2025-08-${String(i + 1).padStart(2, "0")}`
  ),
  datasets: [
    {
      label: "Absent",
      data: Array.from({ length: 60 }, (_, i) => (i >= 10 && i < 20 ? 2 : 1)),
...
export const attendancePercentData = {
  ...
  datasets: [{ data: [261], backgroundColor: ["#3B82F6"], borderWidth: 0 }],
};
...
export const attendanceScatter = {
  datasets: [
    {
      label: "Late Minutes vs Day",
...
export const attendanceTreemap = {
  datasets: [
    {
      tree: [
        { value: 10, label: "Eng" },
...
export const attendanceRadar = {
  labels: ["Punctuality", "Presence", "Overtime", "Leaves", "WFH"],
  datasets: [
    {
      label: "Score",
      data: [80, 85, 60, 50, 70],
